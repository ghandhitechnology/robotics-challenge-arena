# Swarm overhead proof video

This project replays the trained 40-robot native MuJoCo recording from a fixed overhead camera. Every frame uses a saved qpos sample; the renderer does not step physics or interpolate poses.
...
- `renders/swarm-top.mp4`: 1920 × 1080 master.
- `renders/swarm-top-pr.mp4`: 1280 × 720 attachment below 9.5 MB.
