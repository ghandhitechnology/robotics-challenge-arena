# Magnetic swarm-body low oblique proof video

This project replays the 40-module native MuJoCo magnetic-body recording from a fixed low oblique camera. Every frame uses one saved qpos sample; the renderer never steps physics or interpolates poses.
...
- `renders/swarm-body-side.mp4`: 1920 × 1080 master.
- `renders/swarm-body-side-pr.mp4`: 1280 × 720 attachment below 9.5 MB.
