...
Replay the saved native MuJoCo magnetic-body trajectory from a fixed low oblique camera. A compact evidence rail and the frame HUD report only verifier-backed body connectivity and transport measurements.
...
- Fixed low oblique body-focused framing that keeps all 40 modules and both payloads visible.
