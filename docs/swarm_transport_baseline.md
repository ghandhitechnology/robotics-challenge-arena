# Original transport learning baseline

This document preserves the earlier independent-pair transport experiments.
The current connected-body task is documented in [swarm_learning.md](swarm_learning.md).
